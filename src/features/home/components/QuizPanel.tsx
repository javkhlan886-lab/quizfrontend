...
export default function QuizPanel({
  ...
  return (
    <div className="relative mx-auto max-w-2xl rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            {currentQuestion.options.map((option) => (
              <button
                ...
                disabled={phase === "submitting"}
                className="rounded-lg border border-neutral-200 px-3 py-2 text-sm text-neutral-700 transition-colors hover:bg-neutral-50 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {option.text}
              </button>
            ))}
