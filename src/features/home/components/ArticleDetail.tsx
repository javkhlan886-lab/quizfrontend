    ...
    <div className="mt-5">
      ...
      {isLongContent && (
        <div className="mt-1 flex justify-end">
          ...
          >
            {showFullContent ? "Хураангуй нь" : "Дэлгэрэнгүй"}
          </button>
        </div>
      )}
      ...
      <div className="mt-5 flex items-center justify-between">
        <button
          ...
          className="w-full rounded-lg bg-violet-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-violet-700 disabled:cursor-not-allowed disabled:bg-neutral-200 disabled:text-neutral-400 sm:w-auto"
        >
          Шалгалт өгөх
        </button>
      </div>
